...
A RuneLite plugin that shows a colored team badge next to player names in chat, based on which bingo team they are on. Works in public chat, friends chat, clan chat (including guest and GIM), and private messages.
...
5. Optionally click a team's color swatch to change its badge color.
